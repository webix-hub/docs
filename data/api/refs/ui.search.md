...
- api/link/ui.search_attachevent.md - attaches the handler to an inner event of the component (allows behavior customizations)
...
- api/link/ui.search_disabled_config.md - indicates whether an item is enabled
...
- api/link/ui.search_invalid_config.md - specifies, whether the control is valid/invalid after validation
