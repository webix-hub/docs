...
- api/link/ui.rangechart_arialabel_config.md - sets a screen readable label for Chart
...
- api/link/ui.rangechart_container_config.md - an HTML container (or its id) where the component should be initialized
...
- api/link/ui.rangechart_waitdata_other.md - eventual result of an asynchronous operation ('promise' object) for the loaded data
}}
