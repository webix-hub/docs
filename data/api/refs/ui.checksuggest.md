...
- api/link/ui.checksuggest_attachevent.md - attaches the handler to an inner event of the component (allows behavior customizations)
...
- api/link/ui.checksuggest_$skin_other.md - the method which will be called when skin is defined
