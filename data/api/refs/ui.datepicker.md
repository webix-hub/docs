...
- api/link/ui.datepicker_sync.md - allows you to sync two copies of data (all or just a part of it) from one DataCollection to another
...
- api/link/ui.datepicker_inputalign_config.md - the alignment of an input towards its container
...
- api/link/ui.datepicker_invalid_config.md - specifies, whether the control is valid/invalid after validation
...
{{api
- api/link/ui.datepicker_$comparevalue_other.md - compares the old value of the control with the one that is going to be set
...
- api/link/ui.datepicker_$preparevalue_other.md - adjusts the value that is going to be set to the format expected by the control
