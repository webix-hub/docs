...
- api/ui.template_sethtml.md - set html for template
...
- api/ui.template_waitmessage_config.md - defines whether the loading cover should be displayed while loading (actual in case of 'src' parameter)
