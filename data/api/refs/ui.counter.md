...
- api/link/ui.counter_attachevent.md - attaches the handler to an inner event of the component (allows behavior customizations)
...
- api/link/ui.counter_onblur_event.md - fires when focus is moved out of the view
...
- api/link/ui.counter_onfocus_event.md - fires when a view gets focus
...
- api/link/ui.counter_attributes_config.md - sets a hash of HTML input attributes that will be parsed for the Webix input control
...
- api/link/ui.counter_disabled_config.md - indicates whether an item is enabled
...
- api/link/ui.counter_inputalign_config.md - the alignment of an input towards its container
...
- api/link/ui.counter_labelalign_config.md - the alignment of a label towards its container
...
{{api
- api/link/ui.counter_$comparevalue_other.md - compares the old value of the control with the one that is going to be set
...
- api/link/ui.counter_$preparevalue_other.md - adjusts the value that is going to be set to the format expected by the control
...
- api/link/ui.counter_$renderinput_other.md - called each time when component need to paint control's input
