...
- api/link/ui.datasuggest_attachevent.md - attaches the handler to an inner event of the component (allows behavior customizations)
...
- api/link/ui.datasuggest_url_config.md - the URL which the component will use to load data after its initialization
...
- api/link/ui.datasuggest_$skin_other.md - the method which will be called when skin is defined
