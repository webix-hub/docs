...
{{api
- api/ui.accordion_onaftercollapse_event.md - fires after an item expands in the accordion
- api/ui.accordion_onafterexpand_event.md - fires after an item collapses in the accordion
