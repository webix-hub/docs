...
- api/link/ui.colorpicker_invalid_config.md - specifies, whether the control is valid/invalid after validation
...
{{api
- api/link/ui.colorpicker_$comparevalue_other.md - compares the old value of the control with the one that is going to be set
...
- api/link/ui.colorpicker_$preparevalue_other.md - adjusts the value that is going to be set to the format expected by the control
