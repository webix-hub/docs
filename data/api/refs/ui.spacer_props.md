...
- api/link/ui.spacer_container_config.md - an HTML container (or its id) where the component should be initialized
- api/link/ui.spacer_css_config.md - the name of a css class that will be applied to the view container
- api/link/ui.spacer_disabled_config.md - indicates whether an item is enabled
