...
- api/ui.filemanager_onafterleveldown_event.md - fires after selection has been moved one level down
- api/link/ui.filemanager_onafterload_event.md - fires after data loading is complete
- api/ui.filemanager_onafterrun_event.md - fires after a file has been run
...
- api/ui.filemanager_onbeforeleveldown_event.md - fires before selection is moved one level down
...
- api/ui.filemanager_onbeforerun_event.md - fires before a file is run
