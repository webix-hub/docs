...
- api/link/ui.multitext_disabled_config.md - indicates whether an item is enabled
...
- api/ui.multitext_$cssname_other.md - name of the widget the CSS of which you want to inherit for a custom widget
...
- api/link/ui.multitext_$skin_other.md - the method which will be called when skin is defined
