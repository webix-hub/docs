...
- api/link/ui.accordionitem_attachevent.md - attaches the handler to an inner event of the component (allows behavior customizations)
...
- api/link/ui.accordionitem_disabled_config.md - indicates whether an item is enabled
...
- api/link/ui.accordionitem_on_mouse_move_other.md - attaches a mouse move behavior for component items with the specified CSS class
}}
