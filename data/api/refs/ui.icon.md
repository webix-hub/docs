...
- api/link/ui.icon_attachevent.md - attaches the handler to an inner event of the component (allows behavior customizations)
...
- api/link/ui.icon_disabled_config.md - indicates whether an item is enabled
...
- api/link/ui.icon_$skin_other.md - the method which will be called when skin is defined
