...
- api/link/ui.fileview_container_config.md - an html container (or its id) where the component needs initializing
...
- api/link/ui.fileview_$dropallow_other.md - can be redefine if you need custom drop rules
