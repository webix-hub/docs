...
- api/link/ui.unitlist_loadnext.md - sends a request to load the specified number of records to the end of the client-side dataset or to the specified position
...
- api/link/ui.unitlist_validate.md - validates one record or all dataset against the validation rules
}}
...
- api/link/ui.unitlist_onpaste_event.md - fires when the <a href="api/copypaste_clipboard_config.md">clipboard</a> is enabled and the user presses CTRL+V keys combination
