...
- **callback** - (function) contains a code that will be called when the user clicks on the button. As a parameter 
the function takes the *true/false* value - the confirm result status
