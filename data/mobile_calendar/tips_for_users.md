...
2) Webix Scheduler also allows applying templates to its views. Read more in the article mobile_calendar/calendar_templates.md.

3) Elements' sizes are customizable, too. This feature is described in the mobile_calendar/sizing.md article.

4) If you are going to use dhtmlxConnector to load and save data, you should do the following:
