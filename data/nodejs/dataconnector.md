...
This operation corresponds to query type the connector will execute over the database table. If you need to customize this behavior  - go to [DataProcessor docs](desktop/dataprocessor.md).
