...
<table class="inline">
	...
	<tr class="row2">
		<td class="col0 leftalign"><strong>.cancel_icon</strong>  </td><td class="col1"> the "remove_item" icon</td>
	</tr>
    <tr class="row3">
		<td class="col0 leftalign"><strong>.webix_upload_server</strong>  </td><td class="col1"> the "upload_state" area</td>
	</tr>
	<tr class="row4">
		<td class="col0 leftalign"><strong>.icon-ok webix_icon</strong>  </td><td class="col1"> the "upload ready" icon </td>
	</tr>
</table>
