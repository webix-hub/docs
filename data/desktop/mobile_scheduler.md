...
The mobile version of the scheduler. It was developed to be used in mobile web apps that run in Webkit-based browsers on mobile devices (iOS, Android, Blackberry).
...
<table  style='border-left:none !important;' cellspacing="0" cellpadding="5" border="0">
	...
	<tr>
		...
		<td class='topic_description' onclick="displaySubList(event,'manipulations')"></td>
	</tr>
    <tr>
		<td class='topics'>
        	 <h4>
