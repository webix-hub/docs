...
The "datalayout" view is based on Layout and operates the [datastore API](api/refs/datastore.md). 

It's intended for creating complex data structures, e.g. big lists with dynamic data subloading, multipage forms, etc. and allows placing several data components into one layout.
...
Define the config of the datalayout and specify the sublayout in the rows collection. Set the datasource as well:
