...
<img src="image_maps/doublelist_css.png"/>
...
<table class="inline">
	...
	<tr class="row1">
		<td class="col0 leftalign"><strong>.webix_dbllist</strong></td><td class="col1 leftalign">the whole DoubleList  </td>
	</tr>
    <tr class="row2">
		<td class="col0 leftalign"><strong>.webix_list</strong> </td><td class="col1 leftalign">a list in the DoubleList  </td>
	</tr>
	<tr class="row3">
