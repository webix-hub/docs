...
<table class="inline">
	...
	<tr class="row4">
		<td class="col0 leftalign">.webix_list_group  </td><td class="col1">the group header item in the unselected state </td>
	</tr>
	<tr class="row5">
		<td class="col0 leftalign">.webix_arrow_icon  </td><td class="col1">the arrow on the group header item </td>
	</tr>
</table>
