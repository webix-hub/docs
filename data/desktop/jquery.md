...
3 . An **HTML table** can be the **datasource** for the component inited in the same container. Each column in the table is reflected as a template item for the component:
