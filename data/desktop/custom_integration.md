...
Webix offers a humber of ready-made solutions that integrate it with other Javascript libraties and frameworks. 
...
However, it's not possible to provide support for every library or tool that exist in big quantities on the Web. If you haven't found the needed solution among built-in ones,
you can write **your own integration pattern**. Webix offers rather an elegant way to do this. 

The main thing here is to create a new Wevix view that will display the needed tool on the page:
...
This prototype component should inherit from [view](desktop/view.md), a base class for all the ui-related components. Pure view doesn't contain any into and acts as a placeholder for the real component.
...
- **$init**(config) - function that is executed on component initialization. It's argument is the component's configuation object.
