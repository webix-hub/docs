...
Pulldown **Menu** is a ui-related component that lets users select necessary item from the list of grouped items (submenus). Each element of a submenu can start its own submenu. 
...
UI-related menu inherits from [list](desktop/list.md).

<img src="desktop/menu.png" />
