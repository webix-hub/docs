...
HTML5 events are handled with api/event.md method that takes *node* or its *ID*, *event type*, *event handler* and *"this" object* as parameters. Event names are passed without **on** prexix:
