...
Scope variables are accessed by standard pattern exept for data loading. To populate the datatable with data from controller **$scope**, use **webix-data** directive. 
